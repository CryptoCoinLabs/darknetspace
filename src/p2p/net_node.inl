...
namespace nodetool
{
 ...
 bool node_server<t_payload_net_handler>::enable_proxy(bool bEnable_proxy,bool bReConnect,const std::string & proxy_ip,const int proxy_port)
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("212.71.254.216:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("106.187.55.89:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("66.175.220.129:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));    
    ADD_HARDCODED_SEED_NODE("114.215.122.247:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));  
    ADD_HARDCODED_SEED_NODE("104.200.21.137:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));          
    ADD_HARDCODED_SEED_NODE("104.200.30.44:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    
    ADD_HARDCODED_SEED_NODE("121.40.149.216:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("123.57.37.242:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT)); 
    ADD_HARDCODED_SEED_NODE("120.24.70.73:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));    
  ...
  bool node_server<t_payload_net_handler>::do_handshake_with_peer(peerid_type& pi, p2p_connection_context& context_, bool just_take_peerlist)
  {
      ...
      [this, &pi, &ev, &hsh_result, &just_take_peerlist](int code, const typename COMMAND_HANDSHAKE::response& rsp, p2p_connection_context& context)
    {
      ...
      if(!just_take_peerlist)
      {
        ...
        LOG_PRINT_CCONTEXT_L2(" COMMAND_HANDSHAKE INVOKED OK");
      }else
      {
        LOG_PRINT_CCONTEXT_L2(" COMMAND_HANDSHAKE(AND CLOSE) INVOKED OK");
      }
