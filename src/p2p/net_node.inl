...
namespace nodetool
{
 ...
 bool node_server<t_payload_net_handler>::enable_proxy(bool bEnable_proxy,bool bReConnect,const std::string & proxy_ip,const int proxy_port)
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
	...
	ADD_HARDCODED_SEED_NODE("115.29.52.162:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
	ADD_HARDCODED_SEED_NODE("121.40.48.33:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
	ADD_HARDCODED_SEED_NODE("120.24.15.70:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
	ADD_HARDCODED_SEED_NODE("101.200.143.5:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
