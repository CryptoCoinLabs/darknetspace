...
#pragma pack (pop)
  ...
  bool get_block_reward(size_t median_size, size_t current_block_size, uint64_t already_generated_coins, uint64_t already_donated_coins, \
	  uint64_t &reward, uint64_t &max_donation,uint64_t block_height);
