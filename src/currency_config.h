...
#define CURRENCY_BLOCK_GRANTED_FULL_REWARD_ZONE_ENLARGE  3000000 //size of block (bytes) after which reward for block calculated using block size
...
#ifndef TESTNET
#define CURRENCY_BLOCK_GRANTED_FULL_REWARD_ZONE_ENLARGE_STARTING_BLOCK     100000
#else 
